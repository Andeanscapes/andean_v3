...
export const metadata: Metadata = {
    title: 'Login | Arid - Travel & Tourism HTML/Tailwind CSS Template',
        ...
        >
            <div className="max-w-[550px] h-full flex justify-center items-center py-5 px-5 mx-auto">
                <div className="mx-auto bg-white w-full px-base py-base">
                    ...
                    <div className="mt-9">
                        <input type="email" placeholder="Email or Username" className="input_style__primary" />
                    </div>
                    <div className="lg:mt-5 mt-4">
                        <input type="password" placeholder="Your Passowrd" className="input_style__primary" />
                    </div>
                    ...
                    <button aria-label="login form" className="btn_primary__v1 uppercase !w-full justify-center lg:mt-5 mt-4">
                        Login
                    ...
                    <div className="text-center lg:mt-6 mt-5">
                        <a href="#" className="text-dark-3">Forgot your password ?</a>
                    </div>
                </div>
            </div>
        </div>
