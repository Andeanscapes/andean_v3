...
const SearchFormThree = () => {
  ...
  return (
    <>
      <form
        action="#"
        className="container lg:mt-20 md:mt-16 absolute left-0 md:left-1/2 md:-translate-x-1/2 bottom-20 md:bottom-28 z-10"
        autoComplete="off"
      >
        <div className="flex items-center lg:flex-row flex-col space-y-4 lg:space-y-0 lg:space-x-base">
          <div className="relative flex-grow lg:w-auto w-full select_style__two varient-1">
            <Select
          ...
          {/* Replaces react-datepicker: native date inputs */}
          <div className="relative flex-grow lg:w-auto w-full">
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                className="search__daterange lg:h-17 h-14 pr-4 lg:pl-[20px] pl-[16px] lg:text-md text-base w-full placeholder:text-dark-2 font-medium outline-none !font-sans"
              />
              <input
                type="date"
                value={endDate}
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-5 lg:left-base max-w-[20px] text-secondary-1 pointer-events-none">
              <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M16.6667 8.20001C17.125 8.20001 17.5 8.57501 17.5 9.03335V14.1667C17.5 16.6667 16.25 18.3333 13.3333 18.3333H6.66667C3.75 18.3333 2.5 16.6667 2.5 14.1667V9.03335C2.5 8.57501 2.875 8.20001 3.33333 8.20001H16.6667Z" fill="currentColor" />
              </svg>
            </div>
          </div>
          ...
          <button
            type="submit"
            className="block lg:w-auto w-full flex-grow text-center bg-secondary-1 lg:h-17 h-14 font-medium text-md text-white hover:bg-secondary-2 duration-300"
          >
            FIND NOW
          </button>
        </div>
